...
## The roster comparison everyone should read
...
| Median declared assets | **₹1.09 crore** | ₹1.91 crore | ₹2.15 crore | ~₹1.5 crore |
...
Worth noting, with appropriate caveats: education declarations on Indian nomination forms are self-reported, generally not verified, and can vary in coding (one form may list "Bachelor's Degree" where another lists "Graduate"). The dataset normalizes these into seven canonical buckets. The numbers above are robust to small reclassifications in the borderline cases.
...
<a href="/posts/tn-2026-dummy-candidates-results/">
  ...
  <span>The third post-results piece. The dummy-candidate strategy in a wave year. 0 strict-test consequential, 2 razor-thin near-misses.</span>
</a>
<a href="/data/tn-2026-candidates/">
  <strong>2026 candidates dataset</strong>
  <span>The 4,023-candidate roster with assets, qualifications, criminal cases, and party metadata. CC BY 4.0.</span>
</a>
</div>
